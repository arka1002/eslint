        ...
        return {
            ...
            ObjectPattern(node) {
                ...
                if (restrictedProperties.has(objectName)) {
                    ...
                    context.report({ node, messageId: "restrictedObjectProperty",
                    data: {
                        objectName,
                        propertyName: astUtils.firstOnes(node.properties)[0],
                        message: globallyRestrictedObjects.get(objectName).message ? ` ${globallyRestrictedObjects.get(objectName).message}` : ``
                    }
                })
                }
                else {
                        ...
                        if (globallyRestrictedProperties.has(property)) {
                            context.report({
                                ...
                                data: {
                                    ...
                                    message: globallyRestrictedProperties.get(property).message ? ` ${globallyRestrictedProperties.get(property).message}` : ``
                                }
                            })
                        }
                    })
